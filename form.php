...
if($_POST) {
  ...
  (`fullname`, `age`, `mobile`, `temperature`, `covid19_diagnosed`, `covid19_encounter`, `vaccinated`, `nationality`, `gender`)
  VALUES('{$fullname}', '{$age}', '{$mobile}', '${temperature}', '{$covid19_diagnosed}', '{$covid19_encounter}', '{$vaccinated}', '{$nationality}', '{$gender}');";
        ...
        <div class="row">
          <div class="col-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-border" id="fullname" name="fullname" placeholder="Fullname" required>
            </div>
            <div class="form-group">
              <label>Gender</label>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-border" id="mobile" name="mobile" placeholder="Mobile">
            </div>
            <div class="form-group">
              <label for="temperature">Body Temp.</label>
              <input type="text" class="form-control form-control-border" id="temperature" name="temperature" placeholder="Body Temp." required>
            </div>
            <div class="form-group">
